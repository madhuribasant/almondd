...
const About = () => {
  return (
    <>
      ...
      <section className="h-full flex flex-col justify-center items-center gap-4 py-6 ">
        ...
        <ul className="text-white/60 font-light md:w-1/2 w-full px-4 text-sm text-center list-disc ">
